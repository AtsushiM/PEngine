...
b.before=b.target;b.target=this;var d=this.f[b.type]||[],c,e=d.length;a.splice(0,1);for(a[a.length]=b;e--;)if(c=d[e])if(c=c.apply(this,a),c===q||b.g)return c;return b},addChild:function(a){a.b&&a.b.removeChild(a);a.b=this;this.e.push(a)},removeChild:function(a){var b=this.e,d=b.length;if(a)d=m(a,b),-1!==d&&(delete b[d].b,b.splice(d,1));else for(;d--;){a=b;var c=d;delete a[c].b;a.splice(c,1)}}}),G=t(D,{init:function(a){a=a||w;var b={engine:this};this._super();this.setGravity(a.gravity||{});this.n=
a.sticky_threshold||4E-4;this.entities=[];this.d=[];this.p=new E(b);this.r=new F(b)},addEntity:function(a){this.entities.push(a)},removeEntity:function(a){this.k(this.entities,a)},addCollision:function(a){this.d.push(a)},removeCollision:function(a){this.k(this.d,a)},k:function(a,b){var d=m(b,a);-1!==d&&a.splice(d,1)},getGravity:l("a"),setGravity:function(a){this.a=a;this.a.x=r(a.x)?a.x:this.a.x||0;this.a.y=r(a.y)?a.y:this.a.y||9.80665E-4},getEntities:l("entities"),getCollidables:l("d"),getEntitiesAndCollidables:l("u"),
step:function(a){for(var b=this.a.x*a,d=this.a.y*a,c,e=this.entities,g=e.length,k;g--;)c=e[g],c.vx+=c.ax*a+b,c.vy+=c.ay*a+d,c.x+=c.vx*a,c.y+=c.vy*a,k=this.p.detectCollisions(c,this.d),k!=h&&this.r.resolve(c,k),c.emit("step",k)}},f),H=0,I=t(D,{init:function(a){a=a||w;this._super();this.t=H;H++;this.size(a);this.restitution=r(a.restitution)?a.restitution:0.2;this.y=this.x=0;this.position(a.position||w);this.vy=this.vx=0;this.velocity(a.velocity||w);this.ay=this.ax=0;this.acceleration(a.acceleration||
w)},o:function(){this.j=0.5*this.width;this.i=0.5*this.height},size:function(a){this.width=a.width;this.height=a.height;this.o()},position:function(a){r(a.x)&&(this.x=a.x);r(a.y)&&(this.y=a.y)},velocity:function(a){r(a.x)&&(this.vx=a.x);r(a.y)&&(this.vy=a.y)},acceleration:function(a){r(a.x)&&(this.ax=a.x);r(a.y)&&(this.ay=a.y)},getMidX:function(){return this.j+this.x},getMidY:function(){return this.i+this.y},getTop:l("y"),getLeft:l("x"),getRight:function(){return this.x+this.width},getBottom:function(){return this.y+
this.height}},f),E=t(D,{detectCollisions:function(a,b){for(var d=b.length,c;d--;)if(c=b[d],a!==c&&this.collideRect(a,c))return c;return h},collideRect:function(a,b){return a.getBottom()<=b.getTop()||a.getTop()>=b.getBottom()||a.getRight()<=b.getLeft()||a.getLeft()>=b.getRight()?q:p}},f),F=t(D,{init:function(a){this._super();this.m=a.engine},resolve:function(a,b){var d=this.m.n,c=a.getMidX(),e=a.getMidY(),g=b.getMidX(),k=b.getMidY(),c=(g-c)/b.j,e=(k-e)/b.i,k=Math.abs(c),g=Math.abs(e);0.1>Math.abs(k-
g)?(a.x=0>c?b.getRight():b.getLeft()-a.width,a.y=0>e?b.getBottom():b.getTop()-a.height,0.5>Math.random()?(a.vx=-a.s*b.restitution,Math.abs(a.vx)<d&&(a.vx=0)):(a.vy=-a.vy*b.restitution,Math.abs(a.vy)<d&&(a.vy=0))):k>g?(a.x=0>c?b.getRight():b.getLeft()-a.width,a.vx=-a.s*b.restitution,Math.abs(a.vx)<d&&(a.vx=0)):(a.y=0>e?b.getBottom():b.getTop()-a.height,a.vy=-a.vy*b.restitution,Math.abs(a.vy)<d&&(a.vy=0))}},f),J={Entity:I,CollisionDetector:E,CollisionResolver:F,Observer:D};for(f in J)G[f]=J[f];
A.PE=G;}();
